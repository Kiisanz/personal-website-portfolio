...
import { IconError404 } from '@tabler/icons-react'; // Importing Tabler icon for construction
        ...
        <div className={`min-h-screen ${isDark ? 'bg-primary text-light' : 'bg-light text-primary'}`}>
            ...
            <div className='min-h-screen flex flex-col items-center justify-center h-full backdrop-blur-3xl'>
                <div className='flex flex-col items-center justify-center h-full'>
                    <span className='text-8xl text-white font-bold py-4'>404.</span> {/* Icon */}
                    <h1 className='text-4xl font-bold mb-4 text-center'>{t('utils.notfound.title')}</h1> {/* Text */}
                    <p className='text-lg text-center'>{t('utils.notfound.desc')}</p> {/* Description */}
                    <button
